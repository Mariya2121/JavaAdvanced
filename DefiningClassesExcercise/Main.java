...
//        people.stream().filter(predicate).sorted((p1, p2) -> p1.getName().compareTo(p2.getName())).forEach(System.out::println);
        ...
        highestPaidDepartment.getEmployees().stream()
                .sorted((e1, e2) -> (int) (e2.getSalary() - e1.getSalary())).forEach(System.out::println);
    }
}
